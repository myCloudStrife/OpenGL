...
public:
  ...
  void SetUniform(const std::string &location, glm::vec2) const;

  void SetUniform(const std::string &location, glm::vec3) const;

  void SetUniform(const std::string &location, glm::vec4) const;

  void SetUniform(const std::string &location, glm::mat4) const;
